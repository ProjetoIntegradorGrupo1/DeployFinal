...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">wabis documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-068baf4bdbd777d812e3bc77f4909934"' : 'data-target="#xs-components-links-module-AppModule-068baf4bdbd777d812e3bc77f4909934"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-068baf4bdbd777d812e3bc77f4909934"' :
                                            'id="xs-components-links-module-AppModule-068baf4bdbd777d812e3bc77f4909934"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/DeleteEmpresaComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">DeleteEmpresaComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/PostEmpresaComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">PostEmpresaComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/PutEmpresaComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">PutEmpresaComponent</a>
                                            </li>
                                            <li class="link">
